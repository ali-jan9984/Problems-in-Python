...
def is_blackjack(card_one, card_two):
    ...
    if card_one == 'A' and card_two == 'A':
        return False
    elif (card_one == 'A' or card_two == 'A') and (value_of_card_one == 10 or value_of_card_two == 10):
        return True
    elif value_of_card_one <= 10 and value_of_card_two <= 10:
        return False
    else:
        return None
...
def can_double_down(card_one, card_two):
    ...
    value_of_card_one = value_of_card(card_one)
    value_of_card_two = value_of_card(card_two)
    if (value_of_card_one + value_of_card_two) >= 9 and (value_of_card_one + value_of_card_two <= 11):
        return True
    else:
        return False
