...
def approx_average_is_average(hand):
    ...
    mid_card_value = hand[mid]
    return avg_first_last == average or mid_card_value == average
print(approx_average_is_average([1,0,5]))
...
def average_even_is_average_odd(hand):
    ...
    even_index = hand[0::2]
    odd_index = hand[1::2]
    average_even = card_average(even_index)
    average_odd = card_average(odd_index)
