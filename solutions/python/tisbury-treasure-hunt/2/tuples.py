...
def compare_records(azara_record, rui_record):
    ...
    """
    split_coordinates_of_azara = convert_coordinate(azara_record[1])
    return split_coordinates_of_azara == rui_record[1]
...
def create_record(azara_record, rui_record):
    ...
    """
    coordinates_match = compare_records(azara_record,rui_record)
